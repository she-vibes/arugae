...
export default function AruBot({ profile }) {
  const [messages, setMessages] = useState([
    { role:'assistant', content:`Hi ${profile?.display_name || 'there'} 🤍 I'm AruBot — here for you any time, day or night. What's on your mind today?` }
  ])
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          background: `linear-gradient(135deg, ${T.teal}, #7C3AED)`,
        ...
        <div style={{
          ...
          fontSize: 10, color: '#F5894A', fontWeight: 600, flexShrink: 0,
        }}>
        ...
        {messages.map((m, i) => (
          <div key={i} style={{ display: 'flex', justifyContent: m.role === 'user' ? 'flex-end' : 'flex-start' }}>
            <div style={{
              ...
              <p style={{ fontSize: 13, color: 'white', lineHeight: 1.65, margin: 0, whiteSpace: 'pre-line' }}>
                {m.content}
              </p>
            </div>
          </div>
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', gap: 8 }}>
          ...
          <button
            ...
            style={{
              background: input.trim() && remaining > 0
                ? `linear-gradient(135deg, ${T.teal}, #7C3AED)`
