            ...
            <div style={{
              ...
              {onChangeCircle && (
                <div
                  ...
                  style={{ padding:'12px 16px', fontSize:13, color:'white', cursor:'pointer', display:'flex', alignItems:'center', gap:10, borderBottom:'1px solid rgba(255,255,255,0.07)' }}
                >
                  <span>🔄</span> Change Circle
                </div>
              )}
              ...
              <div
                ...
                style={{ padding:'12px 16px', fontSize:13, color:'#F87171', cursor:'pointer', display:'flex', alignItems:'center', gap:10 }}
              >
                <span>→</span> Sign Out
              </div>
            </div>
